...
**Version: v1.1.0** (`VERSION` · `versionName` · [Releases](https://github.com/lamb-liver/appforsale/releases/tag/v1.1.0))
...
|-------|----------------|
| **ui** | `PosViewModel` observes `PosPersistence.snapshot`; cart / catalog / checkout delegate to coordinators; `PosAppShell` handles SAF export and `csvShareUriFlow` sharing; `PosFeedbackManager` centralizes haptic / sound side effects; ads / billing under `ui/ads`, `ui/billing` |
