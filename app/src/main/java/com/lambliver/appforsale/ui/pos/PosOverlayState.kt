...
import com.lambliver.appforsale.domain.DialogState
...
internal class PosOverlayState(
    ...
    fun applyUiEvent(
        ...
        when (event) {
            ...
            -> Unit
            PosUiEvent.ShowSponsorSheet -> billingVm.refreshSponsorProducts()
            ...
            PosUiEvent.ClearCart -> vm.onEvent(com.lambliver.appforsale.domain.PosEvent.ClearCart)
            ...
            is PosUiEvent.ShowDialog -> vm.onEvent(com.lambliver.appforsale.domain.PosEvent.ShowDialog(event.state))
        }
    }
